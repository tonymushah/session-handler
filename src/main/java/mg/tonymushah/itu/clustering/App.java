package mg.tonymushah.itu.clustering;
...
public class App {
    ...
    private static File getRootFolder() {
        try {
            File root;
            String runningJarPath = App.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()
                    .replaceAll("\\\\", "/");
    ...
    public static void main(String[] args) throws Exception {
        ...
        EntityManagerFactory entityManagerFactory = Persistence
                .createEntityManagerFactory("mg.tonymushah.itu.clustering.session-handler");
